...
export const Map = () => {
  return (
    ...
    >
      ...
      <div className="pt-12 text-base font-semibold tracking-tight" style={{ color: '#2286b9' }}>
      ...
      >
        Monitoring & Control for Construction
      </h2>
      <p className="mt-4 max-w-2xl text-center text-base text-balance text-gray-400 sm:mt-8 sm:text-xl">
        Complete oversight of your construction operations across fields,
        construction sites, and team monitoring, delivering insights even in
